...
const ReviewPanel = ({ review, loading = false }) => {
  const { header, loadingState, sectionTitles } = staticReviewContent;
        ...
        <div className="space-y-5">
          ...
          <section>
            <div className="mb-2 flex items-center justify-between">
              ...
              <span className="rounded-full bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-transparent px-2 py-1 text-xs font-medium text-gray-700 dark:text-gray-400">
                ...
                {review.bugs.map((bug, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <span className="rounded-full bg-red-100 dark:bg-red-500/10 px-2 py-1 text-xs font-semibold capitalize text-red-600 dark:text-red-400">
                        {bug.severity}
                      </span>
                    </div>
          ...
          <section>
            ...
            {review.codeQuality?.comments?.length > 0 ? (
              <ul className="space-y-2">
                {review.codeQuality.comments.map((comment, index) => (
                  <li
                    key={index}
          ...
          <section>
            ...
            {review.securityIssues?.length > 0 ? (
              <ul className="list-disc space-y-2 pl-5 text-sm text-gray-700 dark:text-gray-300">
                {review.securityIssues.map((issue, index) => (
          ...
          <section>
            ...
            <pre className="overflow-x-auto rounded-lg border border-gray-300 dark:border-gray-800 bg-gray-900 dark:bg-gray-950 p-4 font-mono text-xs leading-6 text-blue-300 dark:text-blue-200">
              <code>
